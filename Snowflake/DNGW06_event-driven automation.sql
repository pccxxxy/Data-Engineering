-- truncate the target table to avoid confusion
...
-- Use this command if you want to check the configuration of the Snowpipe in details:
...
USING (
        ...
        , country
        , timezone 
        , CONVERT_TIMEZONE( 'UTC',timezone,cdc.datetime_iso8601) as GAMER_LTZ_NAME
        ...
        ON DATE_PART(hour, GAMER_LTZ_NAME) = tod.hour
      ) r
...
INSERT (IP_ADDRESS, GAMER_NAME, GAME_EVENT_NAME
        ...
        , COUNTRY, TIMEZONE, GAMER_LTZ_NAME
        , DOW_NAME, TOD_NAME)
        VALUES
